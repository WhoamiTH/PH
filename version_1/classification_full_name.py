...
def init_label():
    ...
    constraints_resources = {1:'diet', 2:'medical_services',
                             3:'constraints_resources_physical_exercise','constraints_resources_diet':1, 'constraints_resources_medical_services':2,
                             'constraints_resources_physical_exercise':3}
    constraints_diet = {1:'constraints_diet_food', 2:'constraints_diet_unhealthy_habits', 3:'constraints_diet_sensory_appeal',
                        4:'constraints_diet_social', 5:'constraints_diet_psychological_elements','constraints_diet_food':1, 'constraints_diet_unhealthy_habits':2, 'constraints_diet_sensory_appeal':3,
                        'constraints_diet_social':4, 'constraints_diet_psychological_elements':5}
    constraints_psychological_elements = {1:'constraints_psychological_elements_psychological_elements','constraints_psychological_elements_psychological_elements':1}
    ...
    # ------------------------------------motivation---------------------------------------------------------------------
    motivation_diet = {1:'motivation_diet_psychological_elements','motivation_diet_psychological_elements':1}
    motivation_medical_elements = {1:'motivation_medical_elements_medical_services','motivation_medical_elements_medical_services':1}
    motivation_physical_factors = {1:'motivation_physical_factors_physical_exercise','motivation_physical_factors_physical_exercise':1}
    motivation_psychological_elements = {1:'motivation_psychological_elements_psychological_elements', 'motivation_psychological_elements_psychological_elements':1}
    motivation = {1:'motivation_diet', 2:'motivation_medical_elements', 3:'motivation_physical_factors',
                  4:'motivation_phychological_elements',10:motivation_diet,20:motivation_medical_elements,30:motivation_physical_factors, 40:motivation_psychological_elements, 'motivation_diet':1, 'motivation_medical_elements':2, 'motivation_physical_factors':3,
                  'motivation_phychological_elements':4}
    return ikt, psyper, constraints, motivation
...
ikt_label, psyper_label, constraints_label, motivation_lebal = init_label()
...
transform_vector(new_data[0], ikt, ikt_vector)
transform_vector(new_data[0], psyper, psyper_vector)
transform_vector(new_data[0], constraints, constraints_vector)
transform_vector(new_data[0], motivation, motivation_vector)
