...
def init_label():
    ...
    # -----------------------------------constraints---------------------------------------------------------------------
    constraints_resources = {1:'diet', 2:'medical_services', 3:'physical_exercise','diet':1, 'medical_services':2,'physical_exercise':3}
    constraints_diet = {1:'food', 2:'unhealthy_habits', 3:'sensory_appeal',4:'social', 5:'psychological_elements','food':1, 'unhealthy_habits':2, 'sensory_appeal':3,'social':4, 'psychological_elements':5}
    ...
    motivation = {1:'diet', 2:'medical_elements', 3:'physical_factors', 4:'phychological_elements',10:motivation_diet,20:motivation_medical_elements,30:motivation_physical_factors, 40:motivation_psychological_elements, 'diet':1, 'medical_elements':2, 'physical_factors':3, 'phychological_elements':4}
    return ikt, psyper, constraints, motivation
