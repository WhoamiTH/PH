...
sql_con_moti = """
CREATE TABLE constrain_motivation (
person_id INT NOT NULL,
cholesterol FLOAT NOT NULL,
salt FLOAT NOT NULL,
sugar FLOAT NOT NULL,
...
flavour FLOAT NOT NULL,
oder FLOAT NOT NULL,
diet_availability_converience FLOAT NOT NULL,
diet_affordability_price_time FLOAT NOT NULL,
diet_label FLOAT NOT NULL,
diet_brand FLOAT NOT NULL,
diet_peer_group_influence FLOAT NOT NULL,
diet_social_class FLOAT NOT NULL,
diet_knowledge FLOAT NOT NULL,
diet_attitude_belief FLOAT NOT NULL,
diet_risk_expectation FLOAT NOT NULL,
diet_need_urgency FLOAT NOT NULL,
diet_habitual_addiction FLOAT NOT NULL,
diet_social_cultural_ethical_values FLOAT NOT NULL,
diet_familiarity FLOAT NOT NULL,
diet_inntention_motivation FLOAT NOT NULL,
diabetes FLOAT NOT NULL,
hypertension FLOAT NOT NULL,
obesity FLOAT NOT NULL,
breathlessness FLOAT NOT NULL,
...
lack_of_appetite_nausea FLOAT NOT NULL,
sudden_loss_gain_weight FLOAT NOT NULL,
medicial_availability_converience FLOAT NOT NULL,
medicial_affordability_price_time FLOAT NOT NULL,
medicial_trust_authority FLOAT NOT NULL,
BMI FLOAT NOT NULL,
gender FLOAT NOT NULL,
ethnicity FLOAT NOT NULL,
family_history FLOAT NOT NULL,
physical_disease_checkup FLOAT NOT NULL,
body_wellness_signs FLOAT NOT NULL,
physical_availability_converience FLOAT NOT NULL,
physical_affordability_price_time FLOAT NOT NULL,
physical_mood FLOAT NOT NULL,
physical_peer_group_pressure FLOAT NOT NULL,
physical_social_class FLOAT NOT NULL,
physical_motivation FLOAT NOT NULL,
psychologicalattitude_belief FLOAT NOT NULL,
risk_expectation FLOAT NOT NULL,
need_urgency FLOAT NOT NULL,
anxiety_depression FLOAT NOT NULL,
stress FLOAT NOT NULL,
