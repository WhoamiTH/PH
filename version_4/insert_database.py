...
# 	VALUES ('%d', '%d', '%s', '%f', '%f', '%f')"%(code,person_id,time_id,\
# 	alcoholic_beverages,tobacco,drug)
...
# 	VALUES ('%d', '%d', '%s', '%f', '%f', '%f', '%f')"%(code,person_id,time_id,\
# 	visual_appearance,in_mouth_taste,flavour,oder)
...
# 	VALUES ('%d', '%d', '%s', '%f', '%f', '%f', '%f', '%f', '%f', '%f')"%(code,person_id,time_id,\
# 	availability_converience,affordability_price_time,label,\
# 	brand,peer_group_influence,social_class,knowledge)
...
# 	VALUES ('%d', '%d', '%s', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f')"%(code,person_id,time_id,\
# 	breathlessness,shortness_of_breath,middle_of_night_short_of_breath,\
# 	irregular_rapid_Heartbeat,persistent_cough,coughing_up_Pick_foam_mucus,\
# 	chest_pain,fatigue_weakness,oedema,ascites,increased_need_to_urinate_at_night,\
# 	difficulties_concentrating,lack_of_appetite_nausea,sudden_loss_gain_weight)
...
# 	VALUES ('%d', '%d', '%s', '%f', '%f', '%f', '%f', '%f', '%f')"%(code,person_id,time_id,\
# 	BMI,gender,ethnicity,family_history,physical_disease_checkup,body_wellness_signs)
...
# 	VALUES ('%d', '%d', '%s', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f')"%(code,person_id,time_id,\
# 	attitude_belief,risk_expectation,need_urgency,anxiety_depression,stress,\
# 	social_isolation,poverty_financial,peer_group_influence)
...
con_moti = np.loadtxt('con_moti.csv', dtype=np.str, delimiter=',', skiprows=1)
num = con_moti.shape[0]
person_id = con_moti[:,0]
person_id = person_id.astype(np.int)
con_moti = con_moti[:,1:]
con_moti = con_moti.astype(np.float)
...
for i in range(num):
	...
	flavour,\
	oder,\
	availability_converience,\
	affordability_price_time,\
	label,\
	brand,\
	...
	need_urgency,\
	habitual_addiction,\
	sociao_cultural_ethical_values,\
	familiarity,\
	inntention_motivation,\
	diabetes,\
	hypertension,\
	obesity,\
	breathlessness,\
	shortness_of_breath,\
	middle_of_night_short_of_breath,\
	irregular_rapid_Heartbeat,\
	persistent_cough,\
	coughing_up_Pick_foam_mucus,\
	chest_pain,\
	fatigue_weakness,\
	oedema,\
	ascites,\
	increased_need_to_urinate_at_night,\
	difficulties_concentrating,\
	lack_of_appetite_nausea,\
	sudden_loss_gain_weight,\
	availability_converience,\
	affordability_price_time,\
	trust_authority,\
	BMI,\
	...
	social_isolation,\
	poverty_financial,\
	peer_group_influence = con_moti[i]
	sql_con_moti = "INSERT INTO constrain_motivation (person_id,\
	cholesterol,\
	salt,\
	sugar,\
	calories,\
	...
	poverty_financial,\
	peer_group_influence)\
	VALUES ('%d','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f'\
